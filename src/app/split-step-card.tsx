...
export function SplitStepCard({
  ...
  return (
    <article
      className={`grid w-full grid-cols-1 overflow-hidden border border-[var(--rule)] bg-[var(--bone)] shadow-[var(--shadow-elev-1)] md:grid-cols-2 md:items-stretch ${className}`}
